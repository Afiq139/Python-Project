#Adding Text to Your visual Python Models
...
textH=clockR/4
myLabel=text(text="Shafiq's clock", align='center', color=color.blue, height=textH, pos=vector(0,1.1*clockR,-clockT/2), depth=clockT)
